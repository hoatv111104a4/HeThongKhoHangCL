...
public class SanPhamChiTietController {
    ...
    public SanPhamChiTietController(SanPhamChiTietService sanPhamChiTietService, ThuongHieuService thuongHieuService,
            XuatXuService xuatXuService, SwingWeightService swingWeightService,
            TrongLuongService trongLuongService, CongNgheService congNgheService) {
